...
export default function RPCsPage() {
  ...
  return (
    <div className="container mx-auto px-4 pt-32 pb-6 lg:px-8 lg:pt-40 lg:pb-8">
      <div className="space-y-6">
        {/* Header */}
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Avalanche RPC Endpoints</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-lg font-semibold text-foreground">RPC Endpoints</h3>
              <p className="text-sm text-muted-foreground">Available network endpoints for blockchain interaction</p>
            </div>
            
            {endpoints.map((endpoint) => (
              <div key={endpoint.name} className="space-y-4">
                <h4 className="text-base font-medium text-foreground">{endpoint.name}</h4>
                
                <div className="space-y-3">
                  <div>
                    <div className="text-sm text-muted-foreground mb-2">HTTP Endpoint</div>
                    <div className="flex items-center justify-between bg-gray-800 dark:bg-gray-900 rounded p-3">
                      <code className="text-sm font-mono text-white flex-1">{endpoint.http}</code>
                      <Button
                        variant="ghost"
                        size="icon"
                        className="hover:bg-gray-700 text-gray-400 hover:text-white flex-shrink-0 ml-2"
                  ...
                  <div>
                    <div className="text-sm text-muted-foreground mb-2">WSS Endpoint</div>
                    <div className="flex items-center justify-between bg-gray-800 dark:bg-gray-900 rounded p-3">
                      <code className="text-sm font-mono text-white flex-1">{endpoint.wss}</code>
                      <Button
                        variant="ghost"
                        size="icon"
                        className="hover:bg-gray-700 text-gray-400 hover:text-white flex-shrink-0 ml-2"
