        ...
        {quickActions.map((action, index) => (
          ...
          >
            <Link href={action.href} className="block h-full">
              <CardHeader>
                <div className="w-10 h-10 rounded-lg bg-gray-100 flex items-center justify-center group-hover:bg-foreground group-hover:text-background transition-all duration-300">
