  ...
  return (
    <div className="container mx-auto px-4 pt-16 pb-6 lg:px-8 lg:pt-20 lg:pb-8">
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Avalanche Faucet</h1>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Using Code</CardTitle>
            <CardDescription>
...
curl -X POST https://api.avax.network/ext/bc/C/rpc \\
  ...
  -d '{
    ...
    "id": 1
              ...
              <TabsContent value="python-requests" className="space-y-4">
                <p className="text-sm text-muted-foreground">
...
request_faucet_funds(your_address)`)}
              ...
              <TabsContent value="go-http" className="space-y-4">
                <p className="text-sm text-muted-foreground">
